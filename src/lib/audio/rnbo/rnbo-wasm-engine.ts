...
export class s extends _baseEngine__WEBPACK_IMPORTED_MODULE_0__.v {
	...
	handleParameterEvent(t) {
		this.parameterChangeEvent.emit(
			new _event__WEBPACK_IMPORTED_MODULE_2__.DB(t.time, t.index, t.value, t.source)
		)
	}
	handleMidiEvent(t) {
		this.outgoingEvent.emit(
			new _event__WEBPACK_IMPORTED_MODULE_2__.Ym(t.time, t.port, [t.b1, t.b2, t.b3], undefined)
		)
	}
	handleMessageEvent(t) {
		this.outgoingEvent.emit(
			new _event__WEBPACK_IMPORTED_MODULE_2__.f3(
				...
				t.type === 0 ? t.numValue : t.type === 1 ? this.R.retrieveArray(t.listValue) : undefined,
	...
	handlePresetEvent(t) {
		this.outgoingEvent.emit(
			new _event__WEBPACK_IMPORTED_MODULE_2__.bt(
				t.time,
				_event__WEBPACK_IMPORTED_MODULE_2__.l0.Touched
			)
		)
	}
	getParameterValue(t) {
