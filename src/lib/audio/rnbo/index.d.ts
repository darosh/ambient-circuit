 ...
 * @public
 */
export declare function CommonParameterMixin<TBaseClass extends Constructor>(
	baseClass: TBaseClass
): TBaseClass & (new (...args: any[]) => CommonParameterMixin)
...
export declare function createDevice(
	parameters: ICreateDeviceParameters,
	prevDevice?: Device
): Promise<Device>
 ...
 * @public
 */
declare type DependencyLoadDescription =
	| DependencyLoadFailedDescription
	| DependencyLoadSucceededDescription
...
declare const NumberParameter_base: ObjectConstructor &
	(new (...args: any[]) => CommonParameterMixin)
...
declare interface WASMMessageEvent {
	listValue?: any
	numValue?: number
	objectId: string
	tag: string
...
declare interface WASMMIDIEvent {
	b1: number
	b2: number
	b3: number
	length: number
...
declare interface WASMParameterEvent {
	index: number
	source: number
	time: number
	value: any
...
declare interface WASMPresetEvent {
	time: number
}
